#!/usr/bin/python
# coding: utf-8
# re-ecritude en python3 de Cristel !
...
# constantes des touches de fonction du Minitel en mode Videotex ou Mixte
envoi=1
retour=2
repetition=3
guide=4
...
def wait():
  ...
  while conn.read(1) != b' ' : # ESC reçu... on considere qu'on est connecte
    time.sleep(1)
...
def input_key(ligne, colonne, longueur, caractere = '.', data=''):
  "Gestion de zone de saisie"
  texte = ''
  while True:
      c = conn.read(1).decode()
